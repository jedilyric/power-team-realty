    ...
    <main className="pt-24 lg:pt-44">
      <section className="bg-navy py-20 px-6 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-white/70 text-lg max-w-xl mx-auto">Bryan & Jamie respond within 24 hours. Or call us right now — we'd love to chat.</p>
        </motion.div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            <h2 className="font-heading text-3xl text-navy font-bold mb-8">Send Us a Message</h2>
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-8">
            <div>
              <h2 className="font-heading text-3xl text-navy font-bold mb-8">Contact Info</h2>
            ...
            <div>
              <p className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3">Follow Us</p>
